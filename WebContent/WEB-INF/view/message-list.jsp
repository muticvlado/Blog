                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                  	<c:forEach var="message" items="${messages}">
	                    <tr>
	                      <td>${message.id}</td>
	                      <td><fmt:formatDate type = "date" value = "${message.date}"/></td>
	                      <td>${message.author}</td>
	                      <td>${message.email}</td>
	                      <td>${message.text}</td>	                     
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="message-check?id=${message.id}" class="btn btn-info">
	                          ...
	                          <button type="button" class="btn btn-info btn-danger" data-toggle="modal" data-target="#delete-modal-${message.id}">
