                  ...
                  <tbody>
                  	<c:forEach var="slide" items="${slides}">
	                    <tr style="font-size: small">
	                      <td>${slide.id}</td>
	                      <td style="text-align: center"><img src="${slide.image}" style="max-height: 50px"/></td>
	                      <td>${slide.title}</td>	
	                      <td>${slide.button_label}</td> 
	                      <td><a href="${slide.button_url}">${slide.button_url}</a></td> 
	                      <td>${slide.enable}</td>                    
	                      <td>
	                        <div class="btn-group">
	                          <a href="slide-update-form?id=${slide.id}" class="btn btn-info">
	                            <i class="fas fa-edit"></i>
	                          </a>
	                          <button type="button" class="btn btn-info btn-danger" data-toggle="modal" data-target="#delete-modal-${slide.id}">
					      ...
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="slide-delete?id=${slide.id}" class="btn btn-danger">Delete</a>					            
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
