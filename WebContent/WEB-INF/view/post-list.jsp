...
<!--                 <h3 class="card-title">All Posts</h3> -->
                ...
                <div style="max-width: 50%; background-color: #b3cccc; padding: 10px;">
                <br>
                  <form action="search-post-list">
                	<div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" class="form-control" placeholder="Enter part of title"/>  
                        ...
                        <label>Author</label>
                        <input type="text" name="author" class="form-control" placeholder="Enter part of author name"/>  
                         
                        <br>
                        <div class="form-check">
	                        <input class="form-check-input" type="checkbox">
	                        <label class="form-check-label">Enable posts</label>                          
                      	</div> 
                  	...
                  	<c:forEach var="post" items="${posts}">
	                    ...
	                    <c:if test="${post.enable == true}">
	                      ...
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="make-slide?id=${post.id}" class="btn btn-warning">
