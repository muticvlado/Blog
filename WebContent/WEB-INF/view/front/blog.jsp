      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container">
          ...
          <div class="navbar-header d-flex align-items-center justify-content-between">
            <!-- Navbar Brand --><a href="/BlogSpringMvcApp" class="navbar-brand">Blog</a>
            <!-- Toggle Button-->
...
<!--             </h2> -->
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last"><span class="dateUp">${post.date}</span></div>
                  ...
                  <div class="post-footer d-flex align-items-center"><a href="blog-author?username=${post.user.username}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="date"><i class="icon-clock"></i><span class="dateAgo">${post.date}</span></div>
            ...
            <nav aria-label="Page navigation example">
              ...
              <c:forEach begin="1" end="${pageCount}" varStatus="myIndex">
              	<c:if test="${page==myIndex.index}">
              		<li class="page-item"><a href="blog?page=${myIndex.index}" class="page-link active">${myIndex.index}</a></li>
              	</c:if>
              	<c:if test="${page!=myIndex.index}">
              		<li class="page-item"><a href="blog?page=${myIndex.index}" class="page-link">${myIndex.index}</a></li>
              	</c:if>              	
              </c:forEach>                
              </ul>
            </nav>
        ...
        <aside class="col-lg-4">
          ...
          <div class="widget latest-posts">
            ...
            <c:forEach items="${latestPosts}" var="lastPost" begin="0" end="2">
