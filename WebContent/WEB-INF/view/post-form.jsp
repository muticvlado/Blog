...
<body class="hold-transition sidebar-mini" onload="formatDate()">
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <sec:authorize access="hasRole('bloger')">
           <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-plus-square"></i>
              <p>
            ...
            <div class="card card-primary">
              ...
              <form:form action="post-save" modelAttribute="post">
                ...
                <form:hidden path="id"/>
                  ...
                  <div class="form-group">
                    <label>Author</label>
                    <form:select items="${userList}" path="user.username" itemLabel="fullName" itemValue="username" class="form-control" placeholder="Choose author"/>                    
                  </div>
                  <div class="form-group">
                    <label>Tags</label>
...
<script src="https://cdn.jsdelivr.net/npm/jquery.datepicker-plus-css@1.0.0/jquery-datepicker.min.js"></script>
  ...
  <script type="text/javascript">
		...
		function formatDate() {
			...
			datum = datum.substring(0,4) + "/" + datum.substring(5,7) + "/" + datum.substring(8,10);
