        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            ...
            <div class="media align-items-center">
              <img src="${userP.image}" alt="User Avatar" class="img-brand-50 mr-3 img-circle" style="max-height: 75px">
              ...
              <form:form action="user-save" modelAttribute="user">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Name</label>
                    <form:input path="name" class="form-control" placeholder="Enter first name"/>                    
                  </div>
                  <div class="form-group">
                    <label>Surname</label>
                  ...
                  <div class="form-group">
                    <label>Roles</label>
                    <form:select items="${roles}" path="authorities" itemLabel="authority" itemValue="authority" multiple="true" class="form-control" placeholder="Choose tags" />                    
                  </div>
                   <div class="form-group">
