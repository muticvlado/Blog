                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                  	...
                  	<c:forEach var="user" items="${users}">
	                      ...
	                      <td>${user.surname}</td>
	                      <td>${user.phone}</td>	
	                      <td style="text-align: center"><img src="${user.image}" style="max-height: 50px"/></td>	                     
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="user-update-form?username=${user.username}" class="btn btn-info">
	                            <i class="fas fa-edit"></i>
	                          </a>
	                          <a href="user-block?username=${user.username}" class="btn btn-info">
	                          	<c:if test="${user.enabled == false}">
	                          ...
	                          <a href="user-delete-form?username=${user.username}" class="btn btn-info" onclick="return confirm('Are you sure to delete?')">	                        
