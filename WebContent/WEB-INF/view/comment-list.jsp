              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                  	...
                  	<c:if test="${comment.enable == false}">
                  		<tr style="background-color: #d6d6c2; color: white">
                  	</c:if>
                  	<c:if test="${comment.enable == true}">
                  		<tr>
                  	</c:if>                                      
	                      <td>${comment.id}</td>
	                      <td>${comment.post.title}</td>	                      
	                      <td>
	                      	<fmt:formatDate value="${comment.date}" type = "date" pattern="dd.MM.yyyy"/>	                      	
	                      </td>	                       
	                      <td>${comment.text}</td>	   
	                      <td>${comment.author}</td>	                                        
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="comment-toggle?id=${comment.id}" class="btn btn-warning">
	                          <c:if test="${comment.enable == true}">
	                          ...
	                          <button type="button" class="btn btn-info btn-danger" data-toggle="modal" data-target="#delete-modal-${comment.id}">
